...
export default async function MyCourses({ searchParams }: PageProps) {
    ...
    return (
        <>
            <Header />
            <section className="pt-32 pb-20 lg:pt-30 overflow-hidden">
                <div className="max-w-7xl mx-auto p-12">

                    {/* Header */}
                    <div className=" mb-20">
                        <h1 className="text-2xl md:text-4xl font-black bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 dark:from-gray-100 dark:via-blue-100 dark:to-indigo-100 bg-clip-text text-transparent mb-6 leading-tight drop-shadow-lg">
                            Kursus Saya
                        </h1>
                    ...
                    <div className="space-y-12">
                        <h2 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white flex items-center gap-4">
